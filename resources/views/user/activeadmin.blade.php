...
@admin
    <div class="max-w-lg mx-auto mt-4 mr-4 ml-4 pr-4">
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
            <strong class="font-bold">You are admin now!</strong>
            <span class="block sm:inline">Congratulations!. You are assigned as an admin role.</span>
...
@else
    <div class="max-w-lg mx-auto mt-4 mr-4 ml-4 pr-4">
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
            <strong class="font-bold">Not Admin Account!</strong>
            <span class="block sm:inline">Your role is not admin yet, please access admin role for this user.</span>
            <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                <svg class="fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20">
                    <title>Close</title>
