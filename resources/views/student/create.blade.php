...
<div class="p-8">
        ...
        <div class="mr-auto mt-4 bg-gray-800 shadow-lg rounded-lg p-16">
            <form action="{{ route('student.create.action') }}" method="POST">
                {{-- name --}}
                @csrf
                ...
                {{-- fathername --}}
                <label for="fname"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Father Name <span class="text-red-500">*</span> </label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                ...
                {{-- phone --}}
                <label for="phone"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Phone <span class="text-red-500">*</span></label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                ...
                {{-- roll no --}}
                <label for="roll_no"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Roll No <span class="text-red-500">*</span></label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        <x-heroicon-o-user-group class="h-4 w-4 ml-1 mr-2" />
                ...
                {{-- class --}}
                <label for="class"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white"> Class <span class="text-red-500">*</span></label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        <x-heroicon-o-user-group class="h-4 w-4 ml-1 mr-2" />
                ...
                {{-- dob --}}
                <label for="class"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white"> DOB <span class="text-red-500">*</span></label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        <x-heroicon-o-user-group class="h-4 w-4 ml-1 mr-2" />
                ...
                {{-- nrc --}}
                <label for="class"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white"> NRC <span class="text-red-500">*</span></label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        <x-heroicon-o-user-group class="h-4 w-4 ml-1 mr-2" />
                ...
                {{-- address --}}
                <label for="address"
                    class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Address <span class="text-red-500">*</span> </label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
